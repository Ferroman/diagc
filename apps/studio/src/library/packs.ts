 ...
 * threat-model and plan stencils, the Data pack, the vendor logos and
 * Kubernetes icons, then the full AWS icon set — the panel renders categories
 * in this order. */
export const BUNDLED_LIBRARY: Library = {
  categories: [...basicsCategories, ...C4_PACK.categories, ...ACTIVITY_PACK.categories, ...SECOND_ORDER_PACK.categories, ...FISHBONE_PACK.categories, ...THREAT_MODEL_PACK.categories, ...PLAN_PACK.categories, ...DATA_PACK.categories, ...shapesCategories, ...techCategories, ...k8sCategories, ...AWS_PACK.categories],
  entries: [...basicsEntries, ...C4_PACK.entries, ...ACTIVITY_PACK.entries, ...SECOND_ORDER_PACK.entries, ...FISHBONE_PACK.entries, ...THREAT_MODEL_PACK.entries, ...PLAN_PACK.entries, ...DATA_PACK.entries, ...shapesEntries, ...techEntries, ...k8sEntries, ...AWS_CONTAINER_ENTRIES, ...AWS_PACK.entries],
};
