...
export const BUNDLED_LIBRARY: Library = {
  categories: [...C4_PACK.categories, ...ACTIVITY_PACK.categories, ...DATA_PACK.categories, ...techCategories, ...k8sCategories, ...AWS_PACK.categories],
  entries: [...C4_PACK.entries, ...ACTIVITY_PACK.entries, ...DATA_PACK.entries, ...techEntries, ...k8sEntries, ...AWS_CONTAINER_ENTRIES, ...AWS_PACK.entries],
};
